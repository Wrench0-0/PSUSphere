...
SECRET_KEY = 'django-insecure-!bhn(ee#00&8@g!(=cfasog7@@&3fde&qs!!xo9t#cewjpsrzp'

DEBUG = True

ALLOWED_HOSTS = [
    'wrenchie0.pythonanywhere.com',
...
CSRF_TRUSTED_ORIGINS = [
    'https://wrenchie0.pythonanywhere.com',
    'https://psusphere.pythonanywhere.com',
]
